...
public class ContingencyPlan
{
    ...
    private ContingencyPlan(final String code, final String title, final List<ContingencyAlteration> contingencyAlterations) {
        super();
        this.contingencyAlterations = new ArrayList<ContingencyAlteration>();
        this.code = code;
        this.title = title;
    ...
    public static class PlanBuilder
    {
        ...
        public ContingencyPlan build() {
            return new ContingencyPlan(this.code, this.title, this.contingencyAlterations);
        }
    }
}
